...
/**
 * @title QIETreasury
 * @dev Treasury contract for managing QIE deposits and withdrawals on QIE Blockchain Testnet
 */
contract QIETreasury is Ownable, ReentrancyGuard {
    ...
    // Minimum deposit amount (0.001 QIE)
    uint256 public minDeposit = 0.001 ether;
    
    // Maximum deposit amount (100 QIE)
    ...
    /**
     * @dev Deposit QIE to the treasury
     */
    ...
    /**
     * @dev Withdraw QIE from the treasury
     ...
     * @return contractBalance Total QIE in treasury
     * @return totalDeposited Total QIE deposited
     * @return totalWithdrawn Total QIE withdrawn
    ...
    /**
     * @dev Receive function to accept direct QIE transfers
     */
