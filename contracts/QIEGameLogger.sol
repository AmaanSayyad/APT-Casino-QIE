...
/**
 * @title QIEGameLogger
 * @dev Contract for logging game results on QIE Blockchain Testnet
 * Supports Roulette, Mines, Wheel, and Plinko games
 * Includes NFT token ID tracking for game result NFTs
 */
contract QIEGameLogger is Ownable {
    ...
    /**
     * @dev Log a game result with NFT token ID
     * @param player Player address (for server-side logging)
     ...
     * @param nftTokenId Token ID of the minted NFT for this game
    ...
    function logGameResult(
        ...
        // Emit event for QIE Data Streams
